...
acceptance("Community Platform | native Category AutoModerator", function (needs) {
  needs.user();
  ...
  test(
    "creates an AutoModerator rule from the native Category manager surface",
    async function (assert) {
      ...
      assert
        .dom(".dcp-automod-rule")
        .includesText("Maximum trust level: TL0");
    }
  );
});
